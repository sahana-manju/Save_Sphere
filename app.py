...
app.config['MAIL_USERNAME'] = 'abc@gmail.com' # Please replace this by your email id
app.config['MAIL_PASSWORD'] = 'abcd efgh ijkl mnop' # Please replace this by your actual app password
app.config['MAIL_DEFAULT_SENDER'] = 'abc@gmail.com' # Please replace this by the recepient's email id for instance the nearest police department email id
...
def send_email():
    ...
    if  mail_alert != None:
        ...
        msg = Message(message_txt, 
                    recipients=["abc@gmail.com"],# Please replce by recepient's email id
                    body=body_txt)
        mail.send(msg)
        email_sent = True
